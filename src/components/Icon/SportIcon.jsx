export default function SportIcon({ name, label, className = '' }) {
  const commonProps = { role: 'img', 'aria-label': label, className }
  if (name === 'soccer') {
    return (
      <svg {...commonProps} width="16" height="16" viewBox="-30 32 194 194" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <svg {...commonProps} width="16" height="16" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
