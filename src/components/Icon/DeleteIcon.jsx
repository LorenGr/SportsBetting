export default function DeleteIcon({ label = 'Delete' }) {
  return (
    <svg 
      width="30px" 
      height="30px" 
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier"> 
        ...
        <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" sketch:type="MSPage"> 
          <g id="Icon-Set-Filled" sketch:type="MSLayerGroup" transform="translate(-518.000000, -1146.000000)" fill="currentColor"> 
